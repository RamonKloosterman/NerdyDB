  ...
  <form method="post" action="registreren.php">
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
          ...
          <input required type="password" name="password" class="form-control" id="inputPassword" placeholder="Wachtwoord">
      </div>
      </div>
      <div class="form-row">
    <div class="form-group col-md-6">
    ...
    <form action="overzicht.php">
      <button type="submit" name="submitCustomer" class="btn btn-primary">Account aanmaken</button>
    </form>
  </form>
</div>
